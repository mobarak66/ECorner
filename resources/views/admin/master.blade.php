...
<head>
        ...
        <meta charset="utf-8" />
        <title>Ecorner | @yield('title')</title>
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <div class="app-brand">
                                ...
                                <svg class="brand-icon" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" width="30"
                                    height="80" viewBox="0 0 30 33">
                                    <g fill="none" fill-rule="evenodd">
                                    <path class="logo-fill-blue" fill="#7DBCFF" d="M0 4v25l8 4V0zM22 4v25l8 4V0z" />
                                    <path class="logo-fill-white" fill="#FFF" d="M11 4v25l8 4V0z" />
                                    </g>
                                </svg>                    
                                <span class="brand-name text-truncate" style="height:200%;">ECorner Dashboard</span>
                                </a>
                            </div>
                        </div>
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="contacts-grid.html">Manage Company</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="auth-login.html">Add User</a></li>
                        <li><a href="auth-register.html">Manage User</a></li>
